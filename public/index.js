...
var Render = function () {
    function Render(options) {
        ...
        this._handlers = new _handlebars2.default({
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"calculator\">\r\n    <div class=\"calculator-display\">\r\n        <p>0</p>\r\n    </div>\r\n    <div class=\"calculator-buttons\">\r\n        <ul class=\"calculator-buttons-list\">\r\n            <li class=\"manage\" id=\"clearAndForget\">AC</li>\r\n            <li class=\"manage\" id=\"cancelLastPperation\">CE</li>\r\n            <li class=\"calculator-operation\">&#37;</li>\r\n            <li class=\"calculator-operation\">&#42;</li>\r\n            <li class=\"calculator-numbers\">7</li>\r\n            <li class=\"calculator-numbers\">8</li>\r\n            <li class=\"calculator-numbers\">9</li>\r\n            <li class=\"calculator-operation\">&#8722;</li>\r\n            <li class=\"calculator-numbers\">4</li>\r\n            <li class=\"calculator-numbers\">5</li>\r\n            <li class=\"calculator-numbers\">6</li>\r\n            <li class=\"calculator-operation\">&#43;</li>\r\n            <li class=\"calculator-numbers\">1</li>\r\n            <li class=\"calculator-numbers\">2</li>\r\n            <li class=\"calculator-numbers\">3</li>\r\n            <li id=\"calculator-equal\">=</li>\r\n            <li class=\"calculator-numbers\">0</li>\r\n            <li class=\"calculator-numbers\">.</li>\r\n        </ul>\r\n    </div>\r\n</div>";
},"useData":true});
...
var Handlebars = function () {
    function Handlebars(options) {
        (0, _classCallCheck3.default)(this, Handlebars);
    ...
    (0, _createClass3.default)(Handlebars, [{
        key: 'work',
        value: function work(event) {
            var display = this._el.querySelector('.calculator-display');
            var calculatorClass = event.target.className;
        ...
        key: '_numbersAdd',
        value: function _numbersAdd(num) {
        ...
        key: '_operate',
        value: function _operate(operation) {
        ...
        key: '_manage',
        value: function _manage(manager) {
            if (manager === "AC") {
        ...
        value: function _count() {
            ...
            var second = this._buffer[2];
            var operator = this._buffer[1];
        ...
        key: '_isLastElNumber',
        value: function _isLastElNumber() {
